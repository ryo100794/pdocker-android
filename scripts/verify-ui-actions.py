...
def main() -> int:
    ...
    require("compose up links vscode service after successful start", "Service URL $label $url" in main_src and "openServiceWhenReady" in main_src and "ACTION_VIEW" in main_src and "18080 -> \"VS Code\"" in main_src)
