...
def main() -> int:
    ...
    require("overview surfaces storage metrics", "renderStorageMetrics" in main_src and "StorageMetrics" in main_src and "directorySize(pdockerHome)" in main_src and "storage_total_fmt" in string_src)
