...
def main() -> int:
    ...
    require("docker ps columns share one formatter", '"CONTAINER ID" to 14' in main_src and '"PORTS" to 32' in main_src and "fun cell(value: String, width: Int)" in main_src)
